...
The LDA has an accuracy of 69.1% on the training data set and 68.1% on the test data set.  
```{r}
...
The GBM has an accuracy of 99.2% on the training data set and 98.8% on the test data set.  
```{r}
